...
int main(void)
{
 ...
 RightHandElbow = 0.0f;
		...
		bendAngle += 0.55f;
		printf("Value of bend angle is %f\n",bendAngle);
			/*RightHandShoulder = RightHandShoulder - 0.4f;
				RightHandElbow = RightHandElbow - 0.5f;
	...
	void UpdateSkipping()
{
	if (Skipping == 1)
	{
		if (Jump == 1)
		{
			...
			{
				RightLegLower = RightLegLower + 0.38;
				leftLegLower = leftLegLower + 0.38;


				LeftHandElbow = LeftHandElbow - 1.75;
				RightHandElbow = RightHandElbow + 1.75;
