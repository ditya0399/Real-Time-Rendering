...
void display(void)
{
	...
	modelViewProjectionMatrix = mat4::identity();
	modelViewMatrix = translate(-0.4f, 0.0f, -2.5f);
	...
	ScaleMatrix = mat4::identity();
	modelViewProjectionMatrix = mat4::identity();
	modelViewMatrix = translate(-0.2f, 0.0f, -2.5f);
	//ScaleMatrix = scale(2.0f, 2.0f, 2.0f);
	//modelViewMatrix = modelViewMatrix * ScaleMatrix;
	modelViewProjectionMatrix = perspectiveProjectionMatrix * modelViewMatrix;
	glUniformMatrix4fv(mvpUniform, 1, GL_FALSE, modelViewProjectionMatrix);
	...
	ScaleMatrix = mat4::identity();
	modelViewProjectionMatrix = mat4::identity();
	modelViewMatrix = translate(0.6f, 0.0f, -2.5f);
	//ScaleMatrix = scale(2.0f, 2.0f, 2.0f);
	//modelViewMatrix = modelViewMatrix * ScaleMatrix;
	modelViewProjectionMatrix = perspectiveProjectionMatrix * modelViewMatrix;
	glUniformMatrix4fv(mvpUniform, 1, GL_FALSE, modelViewProjectionMatrix);
	...
	ScaleMatrix = mat4::identity();
	modelViewProjectionMatrix = mat4::identity();
	modelViewMatrix = translate(1.4f, 0.0f, -2.5f);
	//ScaleMatrix = scale(2.0f, 2.0f, 2.0f);
	//modelViewMatrix = modelViewMatrix * ScaleMatrix;
	modelViewProjectionMatrix = perspectiveProjectionMatrix * modelViewMatrix;
	glUniformMatrix4fv(mvpUniform, 1, GL_FALSE, modelViewProjectionMatrix);
