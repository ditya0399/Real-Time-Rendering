...
void initialize()
{
	...
	const GLchar *geometryShaderSource =
		"#version 410" \
		"\n" \
		"layout(points,invocations = 18)in;"\
		...
		"gl_Position = u_projectionMatrix * u_viewMatrix *u_modelMatrix * ((gl_in[0].gl_Position )+vec4(0.0, -0.5, 0.0, 0.0)+vec4(randx,randy,randz,0.0) );"\
		"EmitVertex();"\
		"fColor.a=0.5f;"\
	...
	glBindAttribLocation(gShaderProgramObject, VDG_ATTRIBUTE_TEXTURE0, "vTextureCoord");
...
1.0f, 1.0f, 1.0f,0.0f
	...
	glVertexAttribPointer(VDG_ATTRIBUTE_COLOR, 4, GL_FLOAT, GL_FALSE, 0, NULL);
	...
	LoadGLTextures(&gTextureKundali, MAKEINTRESOURCE(IDBITMAP_STONE));
...
void display(void)
{
	...
	modelMatrix = translate(-8.0f, yAnimateSlanting, -8.0f);
	...
	modelMatrix = mat4::identity();
	modelMatrix = translate(-6.3f, yAnimateSlanting2, -10.0f);
	...
	modelMatrix = mat4::identity();
	modelMatrix = translate(-5.8f, yAnimateSlanting3, -10.0f);

	drawGeometry();
	///////////////////////////////////////////////////CENTER UP BACK Y=1.5 //////////////////////

	modelMatrix = mat4::identity();
	modelMatrix = translate(-5.6f, yAnimateSlanting4, -10.0f);
	drawGeometry();

	/////////////////////////////////////////////////////CENTER UP BACK Y=1.5 //////////////////////

	modelMatrix = mat4::identity();
	modelMatrix = translate(-7.0f, yAnimateSlanting5, -10.0f);
	drawGeometry();
	...
	modelMatrix = mat4::identity();
	modelMatrix = translate(-6.5f, yAnimateSlanting7, -10.0f);
	drawGeometry();
...
///////////////////////////////////////
	...
	//////////////////////////////////////////////// 
	yAnimateSlanting = yAnimateSlanting - 0.002f;
	if (yAnimateSlanting <= -0.5f)
	{
		yAnimateSlanting = 3.0f;
	}

	yAnimateSlanting2 = yAnimateSlanting2 - 0.002f;
	...
	yAnimateSlanting3 = yAnimateSlanting3 - 0.002f;
	...
	yAnimateSlanting4 = yAnimateSlanting4 - 0.002f;
	if (yAnimateSlanting4 <= -2.0f)
	{
		yAnimateSlanting4 = 4.5f;
	}

	fprintf(gpFile, "ySlanting5 %f\n", yAnimateSlanting5);
	yAnimateSlanting5 = yAnimateSlanting5 - 0.002f;
	...
	yAnimateSlanting6 = yAnimateSlanting6 - 0.002f;
	if (yAnimateSlanting6 <= -3.0f)
	{
		yAnimateSlanting6 = 5.5f;
	}

	yAnimateSlanting7 = yAnimateSlanting7 - 0.002f;
