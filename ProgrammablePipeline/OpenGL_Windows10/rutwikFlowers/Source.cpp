...
GLfloat materialShininess = 156.0f;
...
int initialize(void)
{
	...
	//myModel = new Model((char *)"nanosuit/lavender/D1202A028.mb");
...
void display(void)
{
	...
	TranslateMatrix = translate(0.0f, -20.0f, -50.0f);
	
	//TranslateMatrix *= scale(20.1f, 20.1f, 20.1f);


	RotationMatrix = rotate(angle1, 0.0f, 1.0f, 0.0f);
	//TranslateMatrix *= RotationMatrix;
	//viewMatrix = lookat(vec3(0.0f, 0.0f, 5.0f), vec3(0.0f, 0.0f, -20.0f), vec3(0.0f, 1.0f, 0.0f));
