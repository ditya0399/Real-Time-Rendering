...
float offset = 0.02; // controls how crooked branches are
...
void display(void)
{
	...
	modelViewMatrix = translate(0.0f, -0.5f, -2.0f);
	...
	// perform necessary transformations
	modelViewMatrix = translate(-1.0f,-0.5f, -2.0f);
	// do necessary matrix multiplication
	// this was internally done by glOrtho() in FFP.	
