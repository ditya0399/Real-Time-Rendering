...
void display(void)
{
	...
	modelViewMatrix = translate(0.0f, 0.0f, -.0f);
	...
	/*glUniformMatrix4fv(uniforms.view.mv_matrix, 1, GL_FALSE, modelViewMatrix);
	glUniformMatrix4fv(uniforms.view.proj_matrix, 1, GL_FALSE, perspectiveProjectionMatrix);*/
