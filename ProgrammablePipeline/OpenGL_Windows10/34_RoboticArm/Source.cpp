...
void display(void)
{
	...
	TranslateMatrix				= translate(0.0f, 0.0f, -12.0f);
...
//	push(modelViewMatrix); //ModelViewMatrix
	//modelViewMatrix = peek();
	RotationMatrix = rotate(0.0f, 0.0f, (GLfloat)shoulder);
	...
	modelViewMatrix *= rotate(0.0f, 0.0f, (GLfloat)elbow);
	modelViewMatrix *= translate(1.0f, 0.0f, 0.0f);
	//push(modelViewMatrix);
	//modelViewMatrix = peek();
