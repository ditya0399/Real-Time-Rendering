...
int initialize(void)
{
	...
	myModel = new Model((char *)"nanosuit/source/Megamind.fbx");
	...
	//Depth Lines
	glClearDepth(1.0f);
	glClearColor(0.0f, 0.25f, 0.00f, 1.0f);
...
void display(void)
{
	...
	TranslateMatrix = translate(0.0f, -20.0f, -30.0f);
	scaleMatrix = scale(0.2f, 0.2f, 0.2f);


	RotationMatrix = rotate(angle1, 0.0f, 1.0f, 0.0f);
	TranslateMatrix *= RotationMatrix;
	viewMatrix = lookat(vec3(0.0f, 5.0f, 20.0f), vec3(0.0f, 0.0f, -10.0f), vec3(0.0f, 1.0f, 0.0f));
