...
float rainSpeed = 0.188f;
float rainSpeed1 = 0.255f;
float rainSpeed2 = 0.098f;
float rainSpeed3 = 0.23f;
float rainSpeed4 = 0.14f;
float rainSpeed5 = 0.132f;
...
void initializeRain()
{
	...
	const GLchar *geometryShaderSource =
		...
		"}"\
		"float randx =200 * rand(vec2(gl_InvocationID,0.0f));"\
		"float randy = rand(vec2(gl_InvocationID,0.0f));"\
		"float randz =  400 * rand(vec2(gl_InvocationID,0.0f));"\
		"in vec4 color[];"\
		"out vec4 fColor;"\
		...
		"vertexOut.light_direction = gs_in[0].light_direction;" \
		"vertexOut.viewVector = gs_in[0].viewVector;" \
		"gl_Position = ( (gl_in[0].gl_Position )+vec4(0.0, 15.5, -50.0, 1.0)+vec4(randx,randy,randz,0.0));"\
		"fColor.a = 0.15;" \
		"EmitVertex();" \
...
void initializeFlowers()
{
	...
	const GLchar *geometryShaderSource =
		...
		"float randX = 100 *rand(vec2(gl_InvocationID * 4.3,0.0)) -45.0;" \
		"float randY =  1.0 * rand(vec2(gl_InvocationID,0.0));" \
		"float randZ =  100 *  rand(vec2(gl_InvocationID * 19.3,0.0)) - 50.0;" \
...
void displayRain()
{
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-5.6f, R_yAnimateSlanting4, 10.0f);
	drawGeometry();

	/////////////////////////////////////////////////////CENTER UP BACK Y=1.5 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-7.0f, R_yAnimateSlanting5, 10.0f);
	drawGeometry();
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting6, 5.0f);

	drawGeometry();
	///////////////////////////////////////////////////CENTER UP BACK Y=1.0 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.5f, R_yAnimateSlanting7, 10.0f);
	drawGeometry();
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-3.8f, R_yAnimateSlanting, 8.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-3.8f, R_yAnimateSlanting2, 8.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-3.8f, R_yAnimateSlanting3, 8.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting4, 10.0f);
	drawGeometry();

	////////////////////////////////////////////////CENTER DOWN BACK Y=-0.5 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting6, 10.0f);
	drawGeometry();

	////////////////////////////////////////////////CENTER DOWN BACK Y=-1.0 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting2, 10.0f);
	drawGeometry();
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-2.0f, R_yAnimateSlanting2, 8.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-2.0f, R_yAnimateSlanting4, 8.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-2.0f, R_yAnimateSlanting6, 8.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-2.0f, R_yAnimateSlanting3, 8.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-5.0f, R_yAnimateSlanting6, 10.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-5.0f, R_yAnimateSlanting2, 10.0f);
	drawGeometry();
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-5.0f, R_yAnimateSlanting5, 5.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-5.0f, R_yAnimateSlanting5, 10.0f);
	drawGeometry();
	////////////////////////////////////////////////CENTER DOWN BACK Y=-2.0//////////////////////
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-3.8f, R_yAnimateSlanting5, 8.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.5f, R_yAnimateSlanting7, 13.0f);
	drawGeometry();
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-5.8f, R_yAnimateSlanting3, 15.0f);

	drawGeometry();
	///////////////////////////////////////////////////CENTER UP BACK Y=1.5 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-5.6f, R_yAnimateSlanting4, 15.0f);
	drawGeometry();

	/////////////////////////////////////////////////////CENTER UP BACK Y=1.5 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-7.0f, R_yAnimateSlanting5, 15.0f);
	drawGeometry();
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting6, 15.0f);

	drawGeometry();
	///////////////////////////////////////////////////CENTER UP BACK Y=1.0 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.5f, R_yAnimateSlanting7, 15.0f);
	drawGeometry();
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-5.8f, R_yAnimateSlanting2, 6.0f);

	drawGeometry();
	///////////////////////////////////////////////////CENTER UP BACK Y=1.5 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-5.6f, R_yAnimateSlanting6, 6.0f);
	drawGeometry();
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting, 12.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting5, 12.2f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting2, 12.5f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting4, 12.7f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting5, 4.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting4, 4.5f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting2, 4.7f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting, -4.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting2, -4.2f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting3, -4.5f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting4, -4.7f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting6, -6.2f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting2, -5.5f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting4, -7.7f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting3, -8.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting4, -9.2f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting3, -8.5f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting6, -9.7f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting6, -10.2f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting, -10.5f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting3, -10.7f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting6, -13.2f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting2, -15.5f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting4, -10.7f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting5, -18.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting2, -18.2f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting3, -18.5f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting4, -18.7f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting6, -19.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting, -19.2f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting4, -19.5f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting2, -19.7f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting6, -20.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting, -20.2f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting2, -20.5f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting5, -20.7f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting, -22.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting5, -22.2f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting2, -22.5f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting4, -22.7f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting5, -22.9f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting2, -23.1f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting6, -23.4f);
...
////	////////  RECTANGLE //////////////
	...
	RotationMatrix = mat4::identity();
	TranslateMatrix = mat4::identity();
	TranslateMatrix = translate(5.0f,8.0f, -20.0f);
	scaleMatrix = scale(20.8f, 20.8f, 20.8f);
	TranslateMatrix *= scaleMatrix;
...
////	////////  RECTANGLE //////////////
	...
	scaleMatrix = scale(0.004f, 0.003f, 0.003f);
	TranslateMatrix *= scaleMatrix;
//
//	RotationMatrix = rotate(-90.0f, 1.0f, 0.0f, 0.0f);
//	//TranslateMatrix *= RotationMatrix; 
...
////
	...
	if (Noise == 1)
	{
		...
		glUniform4f(N_CloudColor, 0.8f, 0.8f, 0.8f, 0.2f);
