...
void initializeBackTerrain()
{
	...
	TB_mvpUniform = glGetUniformLocation(TB_gShaderProgramObject, "u_mvp_matrix");
	TB_projectionUniform = glGetUniformLocation(TB_gShaderProgramObject, "u_p_matrix");
	TB_modelViewUniform = glGetUniformLocation(TB_gShaderProgramObject, "u_modelView_matrix");
...
//	modelMatrix *= rotate(270.0f, 0.0f, 1.0f,0.0f);
	...
	glUniformMatrix4fv(TB_mvpUniform, 1, GL_FALSE, modelViewProjectionMatrix);
	glUniformMatrix4fv(TB_modelViewUniform, 1, GL_FALSE, modelViewMatrix);
