...
struct integrate_functor
{
    ...
    __host__ __device__
    integrate_functor(float delta_time, cudaTextureObject_t noise_Tex) : deltaTime(delta_time), noiseTex(noise_Tex) {}
    ...
    void operator()(Tuple t)
    {
        ...
        float3 noise = noise3D(pos*params.noiseFreq + params.time*params.noiseSpeed, noiseTex);
