...
void display(void)
{
	...
	modelViewMatrix = translate(0.0f, -1.0f, -3.0f);
	...
	mid_x = (-1.0f + 0.0f) / 2.0f;
	mid_y = (1.0f + 1.0f) / 2.0f;
	

	//if(Displacement >=50)
	Displacement = Displacement / 2;

	mid_x += (rand() - 0.5f) * Displacement;
	mid_y += (rand() - 0.5f) * Displacement;
