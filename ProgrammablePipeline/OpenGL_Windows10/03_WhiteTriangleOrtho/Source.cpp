...
int initialize(void)
{
	...
	//For the sake of understanding . GL_ARRAY_BUFFER is in the GPU side and we have bind our CPU side vbo with it like a Pipe to get the access.
...
//Depth Lines
	...
	//initializing Orthographic ProjectionMatrix to identity.
