...
int initialize(void)
{
	...
	glBufferData(GL_ARRAY_BUFFER, 3 * 12 * sizeof(GL_FLOAT), NULL, GL_DYNAMIC_DRAW);
...
void display(void)
{
	...
	modelViewMatrix = translate(0.0f, -2.0f, -9.0f);
	...
	//DirectX is row major.
	//OGL is Coloumn Major.
	...
	glBindVertexArray(vao);
	smileyTextureVert[0] = 0.0f;
	smileyTextureVert[1] = 0.0f;
	smileyTextureVert[2] = 0.0f;
	smileyTextureVert[3] = 1.0f;
	smileyTextureVert[4] = 1.0f;
	smileyTextureVert[5] = 1.0f;
	smileyTextureVert[6] = 1.0f;
	smileyTextureVert[7] = 0.0f;
	// bind with textures
	if (keyPressed == 1)
	{
		
		glActiveTexture(GL_TEXTURE0);			
		//Here,GL_TEXTURE0 gets matched to AMC_ATTRIBUTE_TEXCOORD0 
		glBindTexture(GL_TEXTURE_2D, smileyTexture);			
		glUniform1i(samplerUniform, 0);						
		...
		smileyTextureVert[1] = 0.0f;
		smileyTextureVert[2] = 0.0f;
		smileyTextureVert[3] = 0.5f;
		smileyTextureVert[4] = 0.5f;
		smileyTextureVert[5] = 0.5;
		smileyTextureVert[6] = 0.5;
		smileyTextureVert[7] = 0.0f;
	}
	...
	else if (keyPressed == 3)
	{
		...
		smileyTextureVert[1] = 0.0f;
		smileyTextureVert[2] = 0.0f;
		smileyTextureVert[3] = 2.0f;
		smileyTextureVert[4] = 2.0f;
		smileyTextureVert[5] = 2.0f;
		smileyTextureVert[6] = 2.0f;
		smileyTextureVert[7] = 0.0f;
	}
	else if (keyPressed == 4)
	{
		...
		smileyTextureVert[0] = 0.5f;
		smileyTextureVert[1] = 0.5f;
		smileyTextureVert[2] = 0.5;
		smileyTextureVert[3] = 0.5f;
		smileyTextureVert[4] = 0.5f;
		smileyTextureVert[5] = 0.5f;
		smileyTextureVert[6] = 0.5f;
		smileyTextureVert[7] = 0.5f;
	}
	glBindBuffer(GL_ARRAY_BUFFER, vbo_texture);						
	glBufferData(GL_ARRAY_BUFFER, sizeof(smileyTextureVert), smileyTextureVert, GL_DYNAMIC_DRAW);	
	glBindBuffer(GL_ARRAY_BUFFER, 0);
