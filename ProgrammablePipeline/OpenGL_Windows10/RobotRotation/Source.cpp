...
GLfloat LeftHandElbow = -30.0f;


GLfloat RightHandShoulder = -90.0f;
GLfloat RightHandElbow = -30.0f;
...
////////SITTING ////
int Sitting = 0;
GLfloat UpperChestSitting = 0.3f;
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CHAR:
		...
		case 'a':
			...
			RightLegLower = RightLegLower + 0.35;
			leftLegLower = leftLegLower + 0.35;


			LeftHandElbow = (int)(LeftHandElbow - 1.0) % 360;
			RightHandElbow = (int)(RightHandElbow + 1.0) % 360;
			

			fprintf(gpLogFile, "value of LeftHandElbow is %f\n", LeftHandElbow);
		...
		case 'P':
		case 'p':
			turnAngleLeftHand = turnAngleLeftHand + 0.35f;
		//	fprintf(gpLogFile, "LeftHand is %f\n", turnAngleLeftHand);
			turnAngleRightHand = turnAngleRightHand + 0.35f;
...
//	fprintf(gpLogFile, "Vlue if walking is %d\n", Walking);
	...
	modelMatrix *= rotate(90.0f, 0.0f, 0.0f);
	if (perFragmentLighting == true)
			{
...
//	if (Sitting == 1)
//	{
//		TranslateMatrix = translate(0.0f, FaceSitting, walkingTranslate - 2.0f);
//		if (FaceSitting >= 1.4f)
//			FaceSitting -= 0.0087f;
//	}
//	 else if (Sitting == 2)
//	{
//		TranslateMatrix = translate(0.0f, FaceSitting, walkingTranslate - 2.3f);
//		if (FaceSitting <= 1.8f)
//			FaceSitting += 0.0087f;
//	}
//	else
...
//	if (Sitting == 1)
//	{
//		TranslateMatrix = translate(0.0f, UpperChestSitting, walkingTranslate - 2.3f);
//		if (UpperChestSitting >= -0.3f)
//			UpperChestSitting -= 0.0087f;
//	}
//	else if (Sitting == 2)
//	{
//		TranslateMatrix = translate(0.0f, UpperChestSitting, walkingTranslate - 2.3f);
//		if (UpperChestSitting <= 0.1f)
//			UpperChestSitting += 0.0087f;
//	}
//	else if (Turn == 1)
//	{
//		TranslateMatrix = translate(0.0f, 0.3f, walkingTranslate);
//		//TranslateMatrix *= translate((GLfloat)sin(turnAngle), 0.0f, (GLfloat)cos(turnAngle));
//	}
//	else
//		TranslateMatrix = translate(0.0f, 0.3f, walkingTranslate);
//
//	ScaleMatrix = scale(1.6f, 2.6f, 2.6f);
...
//	RotationMatrix = mat4::identity();
//	ScaleMatrix = mat4::identity();
//	//viewMatrix = vmath::lookat(vec3(-3.7f, 0.0f, 1.9f), vec3(-18.75f, 0.0f, 1.97f), vec3(0.0f, 1.0f, 0.0f));
//
//	
//	RotationMatrix = rotate((GLfloat)RightHandShoulder, 1.0f, 0.0f, 0.0f);
//
//	//RotationMatrix =RotationMatrix *  rotate(-90.0f, 0.0f, 0.0f, 1.0f);
//	ScaleMatrix = scale(0.3f, 0.3f, 0.1f);
//	if (Sitting == 1)
//	{
//		modelMatrix = translate(0.9f, RightHandShoulderSitting, walkingTranslate - 2.0f);
//		if (RightHandShoulderSitting >= 0.5f)
//			RightHandShoulderSitting -= 0.0087f;
//	}
//	else if (Sitting == 2)
//	{
//		modelMatrix = translate(0.9f, RightHandShoulderSitting, walkingTranslate - 2.0f);
//		if (RightHandShoulderSitting <= 1.0f)
//			RightHandShoulderSitting += 0.0087f;
//	}
//	else if (Skipping == 1)
//	{
//		modelMatrix = translate(0.9f, 1.0f, walkingTranslate);
//
//	}
//	else if (Turn == 1)
//	{
//		if (turnAngleRightHand >= 4.199999)
//		{
//			//turnAngleRightHand = 4.199999;
//		}
//		modelMatrix = translate(0.0f, 1.0f, walkingTranslate);
//		modelMatrix *= rotate(0.0f, turnAngleRightHand,0.0f );
//		modelMatrix *= translate(0.9f, 0.0f, 0.3f);
//		//modelMatrix *= translate((GLfloat)sin(turnAngleRightHand), 0.0f, (GLfloat)cos(turnAngleRightHand));
//	}
//	else
//		modelMatrix = translate(0.9f, 1.0f, walkingTranslate);
//	
...
//	//modelMatrix *= rotate(0.0f, 0.0f, turnAngleRightHand);
...
//	if (Sitting == 1)
//	{
//		modelMatrix = translate(-0.9f, LeftHandShoulderSitting, walkingTranslate - 2.0f);
//		if (LeftHandShoulderSitting >= 0.5f)
//			LeftHandShoulderSitting -= 0.0087f;
//	}
//	else if (Sitting == 2)
//	{
//		modelMatrix = translate(-0.9f, LeftHandShoulderSitting, walkingTranslate - 2.0f);
//		if (LeftHandShoulderSitting <= 1.0f)
//			LeftHandShoulderSitting += 0.0087f;
//	}
//	else if (Skipping == 1)
//	{
...
//	else if (Turn == 1)
//	{
//		if (turnAngleLeftHand >= 1.05000)
//		{
//		//	turnAngleLeftHand = 1.05000f;
//		}
//		modelMatrix = translate(0.0f, 1.0f, walkingTranslate);
//		modelMatrix *= rotate(0.0f, turnAngleLeftHand, 0.0f);
//		modelMatrix *= translate(-0.9f, 0.0f, 0.3f);
//	//	modelMatrix *= rotate(0.0f, 260.0f, 0.0f);
//	}
//	else
//		modelMatrix = translate(-0.9f, 1.0f, walkingTranslate);
//	//	push(modelMatrix);
...
//		ScaleMatrix = scale(0.3f, 0.3f, 0.1f);
//
//		modelMatrix = translate(-0.4f, -0.8f, walkingTranslate);
//		//	push(modelMatrix);
//		modelMatrix = modelMatrix * RotationMatrix;
//		modelMatrix *= translate(0.0f, 0.0f, -1.0f);
//		push(modelMatrix);
...
//		//RotationMatrix =RotationMatrix *  rotate(-90.0f, 0.0f, 0.0f, 1.0f);
//		ScaleMatrix = scale(0.3f, 0.3f, 0.1f);
//		modelMatrix = translate(-0.4f, -1.6f, walkingTranslate);
//
//
//		push(modelMatrix);
//		modelMatrix = modelMatrix * RotationMatrix;
...
//
	...
	////RotationMatrix =RotationMatrix *  rotate(-90.0f, 0.0f, 0.0f, 1.0f);
	//ScaleMatrix = scale(0.3f, 0.12f, 0.3f);

	//modelMatrix = translate(1.07f, 0.4f, -8.0f);
