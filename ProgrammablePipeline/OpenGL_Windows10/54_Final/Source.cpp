...
float rainSpeed = 0.408f;
float rainSpeed1 = 0.555f;
float rainSpeed2 = 0.7f;
float rainSpeed3 = 0.63f;
float rainSpeed4 = 0.94f;
float rainSpeed5 = 0.402f;
float rainSpeed6 = 0.702f;
float rainSpeed7 = 0.592f;
float rainSpeed8 = 0.662f;
...
GLfloat R_yAnimateSlanting = 40.0f;			//-0.5

GLfloat R_yAnimateSlanting2 =40.1f;			//-1.0

GLfloat R_yAnimateSlanting3 = 40.2f;			//-1.5

GLfloat R_yAnimateSlanting4 = 40.3f;			//-2.0

GLfloat R_yAnimateSlanting5 = 40.4f;			//-2.5

GLfloat R_yAnimateSlanting6 = 40.5f;			//-3.0

GLfloat R_yAnimateSlanting7 = 40.6f;			//-3.5
GLfloat R_yAnimateSlanting8 = 35.6f;			//-3.5
GLfloat R_yAnimateSlanting9 = 35.6f;			//-3.5
GLfloat R_yAnimateSlanting10 = 35.6f;			//-3.5
GLfloat R_yAnimateSlanting11 = 35.6f;			//-3.5
...
//	myModel = new Model((char *)"nanosuit/treeOakObj/Tree oak N231017.obj");
...
void displayRain()
{
	...
	{ 
	glLineWidth(1.0f);
	//fprintf(gpLogFile, "I am in rainExtra >=0\n");
	...
	////////
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-8.8f, R_yAnimateSlanting7, 7.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-5.8f, R_yAnimateSlanting8, 7.2f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.8f, R_yAnimateSlanting9, 7.4f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-2.8f, R_yAnimateSlanting10, 7.6f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-8.8f, R_yAnimateSlanting8, 7.80f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-5.8f, R_yAnimateSlanting10, 6.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.8f, R_yAnimateSlanting3, 6.5f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-2.8f, R_yAnimateSlanting7, 6.3f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-8.8f, R_yAnimateSlanting6, 10.2f);
	drawGeometry();

	////////////////////////////////////////////////CENTER DOWN BACK Y=-1.0 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-7.0f, R_yAnimateSlanting2, 10.6f);
	drawGeometry();

	////////////////////////////////////////////////CENTER DOWN BACK Y=-1.5 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-7.5f, R_yAnimateSlanting5, 10.8f);
	drawGeometry();
	////////////////////////////////////////////////CENTER DOWN BACK Y=-2.0//////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.3f, R_yAnimateSlanting4, 10.9f);
	drawGeometry();

	////////////////////////////////////////////////CENTER DOWN BACK Y=-2.5//////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.8f, R_yAnimateSlanting2, 11.1f);
	drawGeometry();
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.2f,R_yAnimateSlanting, 12.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.4f, R_yAnimateSlanting5, 12.2f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-7.2f, R_yAnimateSlanting2, 12.4f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-7.8f, R_yAnimateSlanting4, 12.6f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-8.0f, R_yAnimateSlanting7, 13.0f);
	drawGeometry();

	////////////////////////////////////////////////CENTER DOWN BACK Y=-0.5 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-8.8f, R_yAnimateSlanting8, 13.2f);
	drawGeometry();

	////////////////////////////////////////////////CENTER DOWN BACK Y=-1.0 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-7.0f, R_yAnimateSlanting9, 13.4f);
	drawGeometry();

	////////////////////////////////////////////////CENTER DOWN BACK Y=-1.5 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-7.5f, R_yAnimateSlanting10, 13.6f);
	drawGeometry();
	////////////////////////////////////////////////CENTER DOWN BACK Y=-2.0//////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.3f, R_yAnimateSlanting4, 13.8f);
	drawGeometry();

	////////////////////////////////////////////////CENTER DOWN BACK Y=-2.5//////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.8f, R_yAnimateSlanting2, 14.0f);
	drawGeometry();
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.2f, R_yAnimateSlanting11, 9.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.4f, R_yAnimateSlanting8, 9.2f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-7.2f, R_yAnimateSlanting9, 9.4f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-7.8f, R_yAnimateSlanting7, 9.6f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-2.0f, R_yAnimateSlanting, 6.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-2.5f, R_yAnimateSlanting2, 6.2f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-3.0f, R_yAnimateSlanting4, 6.4f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-3.5f, R_yAnimateSlanting6, 6.6f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-4.0f, R_yAnimateSlanting3, 6.8f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-5.8f, R_yAnimateSlanting5, 7.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-5.0f, R_yAnimateSlanting3, 7.2f);
	drawGeometry();

	/////////////////////////////////////////////////CENTER UP BACK Y=2.5//////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-4.5f, R_yAnimateSlanting6, 7.4f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-5.0f, R_yAnimateSlanting, 7.6f);

	drawGeometry();
	/////////////////////////////////////////////////CENTER UP BACK Y=1.5 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-5.2f, R_yAnimateSlanting2, 7.8f);
	drawGeometry();

	/////////////////////////////////////////////////CENTER UP BACK Y=1.5 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.9f, R_yAnimateSlanting4, 8.0f);
	drawGeometry();
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-4.1f, R_yAnimateSlanting6, 4.0f);
	drawGeometry();
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting, 4.2f);
	drawGeometry();

	////////////////////////////////////////////////CENTER DOWN BACK Y=-0.5 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.5f, R_yAnimateSlanting6, 4.4f);
	drawGeometry();

	////////////////////////////////////////////////CENTER DOWN BACK Y=-1.0 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-7.0f, R_yAnimateSlanting, 4.6f);
	drawGeometry();

	////////////////////////////////////////////////CENTER DOWN BACK Y=-1.5 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-7.5f, R_yAnimateSlanting5, 4.8f);
	drawGeometry();
	////////////////////////////////////////////////CENTER DOWN BACK Y=-2.0//////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-8.0f, R_yAnimateSlanting3, 5.0f);
	drawGeometry();

	////////////////////////////////////////////////CENTER DOWN BACK Y=-2.5//////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-8.5f, R_yAnimateSlanting2, 5.2f);
	drawGeometry();
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-3.8f, R_yAnimateSlanting4, 17.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-3.0f, R_yAnimateSlanting2, 17.2f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-2.8f, R_yAnimateSlanting5, 17.4f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-1.8f, R_yAnimateSlanting, 17.6f);

	drawGeometry();


	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-4.8f, R_yAnimateSlanting3, 17.8f);

	drawGeometry();
	///////////////////////////////////////////////////CENTER UP BACK Y=1.5 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-5.6f, R_yAnimateSlanting4, 18.0f);
	drawGeometry();

	/////////////////////////////////////////////////////CENTER UP BACK Y=1.5 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-7.0f, R_yAnimateSlanting5, 14.0f);
	drawGeometry();
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.5f, R_yAnimateSlanting6, 14.2f);

	drawGeometry();
	///////////////////////////////////////////////////CENTER UP BACK Y=1.0 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-7.2f, R_yAnimateSlanting7, 14.8f);
	drawGeometry();


	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-8.8f, R_yAnimateSlanting3, 15.0f);

	drawGeometry();
	///////////////////////////////////////////////////CENTER UP BACK Y=1.5 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-9.6f, R_yAnimateSlanting4, 15.2f);
	drawGeometry();

	/////////////////////////////////////////////////////CENTER UP BACK Y=1.5 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-11.0f, R_yAnimateSlanting5, 15.4f);
	drawGeometry();
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting6, 15.6f);

	drawGeometry();
	///////////////////////////////////////////////////CENTER UP BACK Y=1.0 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-8.5f, R_yAnimateSlanting7, 15.8f);
	drawGeometry();



	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-3.8f, R_yAnimateSlanting3, 16.0f);

	drawGeometry();
	///////////////////////////////////////////////////CENTER UP BACK Y=1.5 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-9.6f, R_yAnimateSlanting4, 16.0f);
	drawGeometry();
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-2.6f, R_yAnimateSlanting6, 6.5f);
	drawGeometry();

	/////////////////////////////////////////////////////CENTER UP BACK Y=1.5 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-7.0f, R_yAnimateSlanting4, 6.3f);
	drawGeometry();
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.0f, R_yAnimateSlanting5, 6.8f);

	drawGeometry();
	///////////////////////////////////////////////////CENTER UP BACK Y=1.0 //////////////////////

	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-6.5f, R_yAnimateSlanting6, 7.0f);
	drawGeometry();
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-9.0f, R_yAnimateSlanting5, 16.0f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-3.0f, R_yAnimateSlanting2, 16.8f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-5.0f, R_yAnimateSlanting4, 20.2f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-4.0f, R_yAnimateSlanting2, 1.7f);
	...
	R_modelMatrix = mat4::identity();
	R_modelMatrix = translate(-3.0f, R_yAnimateSlanting2, 3.7f);
	...
	if(rainExtra == 1)
	{ 
		//fprintf(gpLogFile, "I am in rainExtra == 1 ----------------------------->\n");
	// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	R_yAnimateSlanting = R_yAnimateSlanting - rainSpeed8;
	if (R_yAnimateSlanting <= 5.0f)
	{
		R_yAnimateSlanting = 40.0f;
	}

	R_yAnimateSlanting2 = R_yAnimateSlanting2 - rainSpeed3;
	if (R_yAnimateSlanting2 <= 5.0f)
	{
		R_yAnimateSlanting2 = 40.1f;
	}


	R_yAnimateSlanting3 = R_yAnimateSlanting3 - rainSpeed4;
	if (R_yAnimateSlanting3 <= 5.0f)
	{
		R_yAnimateSlanting3 = 40.2f;
	}


	R_yAnimateSlanting4 = R_yAnimateSlanting4 - rainSpeed6;
	if (R_yAnimateSlanting4 <= 5.0f)
	{
		R_yAnimateSlanting4 = 40.3f;
	}

	//fprintf(gpLFile, "ySlanting5 %f\n", yAnimateSlanting5);
	R_yAnimateSlanting5 = R_yAnimateSlanting5 - rainSpeed1;
	if (R_yAnimateSlanting5 <= 5.0f)
	{

		R_yAnimateSlanting5 = 40.4f;

	}

	R_yAnimateSlanting6 = R_yAnimateSlanting6 - rainSpeed2;
	if (R_yAnimateSlanting6 <= 5.0f)
	{
		R_yAnimateSlanting6 = 40.5f;
	}

	R_yAnimateSlanting7 = R_yAnimateSlanting7 - rainSpeed7;
	if (R_yAnimateSlanting7 <= 5.0f)
	{
		R_yAnimateSlanting7 = 40.6f;
	}

	R_yAnimateSlanting8 = R_yAnimateSlanting8 - rainSpeed3;
	if (R_yAnimateSlanting8 <= 5.0f)
	{
		R_yAnimateSlanting8 = 35.6f;
	}

	R_yAnimateSlanting9 = R_yAnimateSlanting9 - rainSpeed;
	if (R_yAnimateSlanting9 <= 5.0f)
	{
		R_yAnimateSlanting9 = 35.6f;
	}
	R_yAnimateSlanting10 = R_yAnimateSlanting10 - rainSpeed6;
	if (R_yAnimateSlanting10 <= 5.0f)
	{
		R_yAnimateSlanting10 = 35.6f;
	}

	R_yAnimateSlanting11 = R_yAnimateSlanting11 - rainSpeed7;
	if (R_yAnimateSlanting10 <= 5.0f)
	{
		R_yAnimateSlanting10 = 35.6f;
	}
...
//	TranslateMatrix *= RotationMatrix;
	...
	if (rainExtra >= 0)
	{
		viewMatrix = lookat(vec3(26.0, 12.0f, 18.0), vec3(26.0, 12.0f, -300.0f), vec3(0.0f, 1.0f, 0.0f));
...
//	// perform necessary transformations
	...
	//fprintf(gpLogFile, "xView ------>  %f\n", xView);
	//fprintf(gpLogFile, "zView ------>  %f\n", zView);
	...
	//glUniform1i(Flowers_gTextureSamplerUniform, 2);
