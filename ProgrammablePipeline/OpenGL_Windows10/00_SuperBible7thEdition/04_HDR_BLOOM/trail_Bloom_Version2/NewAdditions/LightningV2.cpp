...
void display(void)
{
	...
	mat_model = translate(0.0f, -0.5f, -2.0f);
...
//	glUniformMatrix4fv(modelUniform, 1, GL_FALSE, mat_model);
//	glUniformMatrix4fv(mvpUniform, 1, GL_FALSE, modelViewProjectionMatrix);
//	gNumberOfLineSegments = 8;
//	glUniform1i(gNumberOfSegmentUniform, gNumberOfLineSegments);
//	glUniform1f(b0Uniform, 1.0f);
//	glUniform1f(b1Uniform, 1.0f);
//	glUniform1f(lengthUniform, 0.002f);
//	glUniform1i(gNumberOfStripsUniform, 1);
//
//	glBindVertexArray(vao_LightingSeed);
//
...
//	gNumberOfLineSegments = 8;
//	glUniform1i(gNumberOfSegmentUniform, gNumberOfLineSegments);
//	glUniform1f(b0Uniform, -1.8f);
//	glUniform1f(b1Uniform, 0.5f);
//	glUniform1f(lengthUniform, 0.002f);
//	glUniform1i(gNumberOfStripsUniform, 1);
//
//	glBindVertexArray(vao_LightingSeed);
...
//	gNumberOfLineSegments = 8;
//	glUniform1i(gNumberOfSegmentUniform, gNumberOfLineSegments);
//	glUniform1f(b0Uniform, 0.8f);
//	glUniform1f(b1Uniform, 4.0f);
//	glUniform1f(lengthUniform, 0.002f);
//	glUniform1i(gNumberOfStripsUniform, 1);
//
//	glBindVertexArray(vao_LightingSeed_Tesselleted);
...
//	glUniformMatrix4fv(modelUniform, 1, GL_FALSE, mat_model);
//	glUniformMatrix4fv(mvpUniform, 1, GL_FALSE, modelViewProjectionMatrix);
//	gNumberOfLineSegments = 5;
//	glUniform1i(gNumberOfSegmentUniform, gNumberOfLineSegments);
//	glUniform1f(b0Uniform, 2.5f);
//	glUniform1f(b1Uniform, 3.0f);
//	glUniform1f(lengthUniform, 2.9f);
//	glUniform1i(gNumberOfStripsUniform, 1);
//
//	glBindVertexArray(vao_LightingSeed);
//
