...
///////
 ...
 GLfloat black[] = { 1.0f, 0.0f, 0.0f, 1.0f };
 GLfloat one = 1.0f;
int i;
float last_time = 0.0;
...
void display(void)
{
	...
	transforms->mat_proj = vmath::perspective(50.0f, (float)gWindowWidth / (float)gWindowHeight, 1.0f, 1000.0f);
...
//mat_model = translate(0.0f, 0.0f, -2.0f);
	//mat_model *= rotate(90.0f, 1.0f, 0.0f, 0.0f);
